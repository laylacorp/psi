                                            ...
                                            <div class="card-block tab-icon">
                                                <div class="row">
                                                    <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <form id="form_job" action="{{ route('simpan_job') }}" method="POST" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        type="checkbox"
                                                                                                        id="dtt" name="nama_benefit[]" value="disediakan_tempat_tinggal">
                                                                                                    <label
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        class="border-checkbox"
                                                                                                        type="checkbox"
                                                                                                        name="nama_benefit[]" value="disediakan_makan" id="dm">
                                                                                                    <label
                                                                                                        class="border-checkbox-label"
                                                                                                        for="dm">Disediakan
                                                                                                        makan
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        class="border-checkbox"
                                                                                                        type="checkbox"
                                                                                                        name="nama_benefit[]" value="disediakan_tunjangan_makan" id="dtm">
                                                                                                    <label
                                                                                                        class="border-checkbox-label"
                                                                                                        for="dtm">Disediakan
                                                                                                        tunjangan makan
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        class="border-checkbox"
                                                                                                        type="checkbox"
                                                                                                        name="nama_benefit[]" value="disediakan_asuransi_kerja" id="dak">
                                                                                                    <label
                                                                                                        class="border-checkbox-label"
                                                                                                        for="dak">Disediakan
                                                                                                        asuransi kerja
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        class="border-checkbox"
                                                                                                        type="checkbox"
                                                                                                        name="nama_benefit[]" value="disediakan_transportasi_dari_tempat_tinggal_ke_tempat_kerja" id="dttk">
                                                                                                    <label
                                                                                                        class="border-checkbox-label"
                                                                                                        for="dttk">Disediakan
                                                                                                        transportasi dari
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <div class="col-sm-12">
                                                                                            <label class="col-form-label"
                                                                                                ...
                                                                                                Galeri</label>
                                                                                                <input type="file" class="form-control form-control-success" id="nama_galeri" name="nama_galeri[]" multiple>
